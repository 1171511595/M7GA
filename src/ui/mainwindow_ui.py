...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionden = QAction(MainWindow)
        self.actionden.setObjectName(u"actionden")
        self.actionden2 = QAction(MainWindow)
        self.actionden2.setObjectName(u"actionden2")
        self.actionden3 = QAction(MainWindow)
        self.actionden3.setObjectName(u"actionden3")
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.listView = QListView(self.centralwidget)
        self.listView.setObjectName(u"listView")
        self.listView.setGeometry(QRect(330, 60, 256, 192))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(330, 20, 91, 21))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 20, 91, 16))
        self.listView_2 = QListView(self.centralwidget)
        self.listView_2.setObjectName(u"listView_2")
        self.listView_2.setGeometry(QRect(10, 60, 256, 192))
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 270, 71, 21))
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(110, 270, 71, 21))
        self.label_5 = QLabel(self.centralwidget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(10, 430, 141, 41))
        ...
        self.menu.addAction(self.actionden)
        self.menu.addAction(self.actionden2)
        self.menu.addAction(self.actionden3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionden.setText(QCoreApplication.translate("MainWindow", u"\u767b\u5f55B\u7ad9\u8d26\u53f7", None))
        self.actionden2.setText(QCoreApplication.translate("MainWindow", u"\u767b\u5f55\u6296\u97f3\u8d26\u53f7", None))
        self.actionden3.setText(QCoreApplication.translate("MainWindow", u"\u767b\u5f55\u5feb\u624b\u8d26\u53f7", None))
